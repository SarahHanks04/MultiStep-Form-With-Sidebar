...
// import { setAddOnsMonthly } from "../Slice/Slice";
...
//     e.preventDefault();
//     dispatch(setAddOnsMonthly(selectedAddOns));
//     navigate("/summary");
//   };

//   return (
//     <div>
//       {/* Add your form content for AddOnsMonthly */}
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-6">
            <label className="border border-blue-500 p-3 rounded-lg cursor-pointer flex items-center justify-between">
              ...
              <span className="text-blue-950 text-sm">+$1/mo</span>
            </label>
            ...
            <label className="border border-blue-500 p-3 rounded-lg cursor-pointer flex items-center justify-between">
              ...
              <span className="text-blue-950 text-sm">+$2/mo</span>
            </label>
